    ...
    resources: {
      ...
      en: {
        translation: {
          ...
          amela_c: 'Providing software development and IT services',
          ...
          asm_c:
            '- Description: A mobile app that helps you order food & drinks for delivery and takeaway.\n- Technology: Nodejs, Socket.IO, React Native, AWS\n- Responsibility: Analysis and development',
          tps_c:
            '- Description: Product delivering Service from Japan to overseas\n- Technology: Nodejs, ReactJS, FedEx API, DHL API, AWS\n- Responsibility: Analysis and development',
          fax_c:
            '- Description: Online fax sending system via web platform\n- Technology: Nodejs, Socket.IO, ReactJS, Freeswitch, AWS\n- Responsibility: Analysis and development',
          lsa_c:
            '- Description: A live streaming platform\n- Technology: Nodejs, Socket.IO, ReactJS, Agora Platform\n- Responsibility: Analysis and development',
