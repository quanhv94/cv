    ...
    resources: {
      en: {
        translations: {
          ...
          'rabita_c': 'Providing online educational solutions for companies and enterprise businesses',
          ...
          'safecracker_c': '- Description: 3D javascript web game\n- Technology: BabylonJS\n- Responsibility: Development',
          ...
          'talk-to-stranger_c': '- Description: A chat application to talk to a random user\n- Technology: NodeJS, Socket.io, ReactJS\n- Responsibility: Analysis and design, development\n- Side project',
          'rabido_c': '- Description: Internal online training system for enterprise businesses\n- Technology: PHP, MYSQL, Firebase, React Native\n- Responsibility: Mobile app development',
          'eschool_c': '- Description: Online system to help user speak with the foreign teachers\n- Technology: PHP, Nodejs, Socket.IO, WebRTC, ReactJS\n- Responsibility: Analysis and development',
      ...
      vn: {
        translations: {
          ...
          'rabita_c': 'Cung cấp các giải pháp đào tạo trực tuyến cho doanh nghiệp',
